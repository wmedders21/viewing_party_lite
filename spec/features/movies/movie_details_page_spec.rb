...
RSpec.describe 'Movie details page' do
  describe 'As a user when I visit the Movie details page' do
    xit 'displays a button to create a viewing party and a button to return to the discover page', :vcr do
    ...
    xit 'displays movie details', :vcr do
      user1 = User.create!(name: 'Will', email: '123@mail.com')
      user2 = User.create!(name: 'Craig', email: 'abc@mail.com')
    ...
    xit 'displays a count of total views', :vcr do
      user1 = User.create!(name: 'Will', email: '123@mail.com')
      user2 = User.create!(name: 'Craig', email: 'abc@mail.com')
